...
years_visited.shift
#! the method .unshift will add the element 2017 at the front of the Array f Strings in years_visited
...
#! Example: years_visited = [2018, 2019, 2020, 2021]
#1 years_visited[2] will yield the output 2020 (index position 2)
